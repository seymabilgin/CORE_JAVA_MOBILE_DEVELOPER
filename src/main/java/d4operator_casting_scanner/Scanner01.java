...
//Example 1: Ask the user for their age and print it to the console.
        ...
        //3.adim: Olusturdugumuz obje üzerinden uygun method ile kullanicinin girdigi veriyi alip memory'e yerlestirelim

        byte age = input.nextByte(); //yas icin byte uygun oldugu icin sectik ama genellikle int yazıp gecerler
